...
pub struct LibVisa {
    ...
    pub viOpenDefaultRM: unsafe extern "C" fn(vi: ViPSession) -> ViStatus,
    pub viFindRsrc: unsafe extern "C" fn(
        sesn: ViSession,
        expr: ViConstString,
        vi: ViPFindList,
        retCnt: ViPUInt32,
    ...
    pub viFindNext: unsafe extern "C" fn(vi: ViFindList, desc: *mut ViChar) -> ViStatus,
    pub viParseRsrc: unsafe extern "C" fn(
        rmSesn: ViSession,
        rsrcName: ViConstRsrc,
        intfType: ViPUInt16,
        intfNum: ViPUInt16,
    ) -> ViStatus,
    pub viParseRsrcEx: unsafe extern "C" fn(
        rmSesn: ViSession,
        rsrcName: ViConstRsrc,
        intfType: ViPUInt16,
        intfNum: ViPUInt16,
    ...
    pub viClose: unsafe extern "C" fn(vi: ViObject) -> ViStatus,
    pub viSetAttribute:
        unsafe extern "C" fn(vi: ViObject, attrName: ViAttr, attrValue: ViAttrState) -> ViStatus,
    pub viGetAttribute: unsafe extern "C" fn(
        vi: ViObject,
        attrName: ViAttr,
        attrValue: *mut ::std::os::raw::c_void,
    ) -> ViStatus,
    pub viStatusDesc:
        unsafe extern "C" fn(vi: ViObject, status: ViStatus, desc: *mut ViChar) -> ViStatus,
    pub viTerminate:
        unsafe extern "C" fn(vi: ViObject, degree: ViUInt16, jobId: ViJobId) -> ViStatus,
    pub viLock: unsafe extern "C" fn(
        vi: ViSession,
    ...
    pub viUnlock: unsafe extern "C" fn(vi: ViSession) -> ViStatus,
    pub viEnableEvent: unsafe extern "C" fn(
        vi: ViSession,
        eventType: ViEventType,
        mechanism: ViUInt16,
        context: ViEventFilter,
    ) -> ViStatus,
    pub viDisableEvent: unsafe extern "C" fn(
        vi: ViSession,
        eventType: ViEventType,
        mechanism: ViUInt16,
    ) -> ViStatus,
    pub viDiscardEvents: unsafe extern "C" fn(
        vi: ViSession,
        eventType: ViEventType,
        mechanism: ViUInt16,
    ) -> ViStatus,
    pub viWaitOnEvent: unsafe extern "C" fn(
        vi: ViSession,
    ...
    pub viInstallHandler: unsafe extern "C" fn(
        vi: ViSession,
        eventType: ViEventType,
        handler: ViHndlr,
        userHandle: ViAddr,
    ) -> ViStatus,
    pub viUninstallHandler: unsafe extern "C" fn(
        vi: ViSession,
        eventType: ViEventType,
        handler: ViHndlr,
        userHandle: ViAddr,
    ) -> ViStatus,
    pub viRead: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViPBuf,
        cnt: ViUInt32,
        retCnt: ViPUInt32,
    ) -> ViStatus,
    pub viReadAsync: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViPBuf,
        cnt: ViUInt32,
        jobId: ViPJobId,
    ) -> ViStatus,
    pub viReadToFile: unsafe extern "C" fn(
        vi: ViSession,
        filename: ViConstString,
        cnt: ViUInt32,
        retCnt: ViPUInt32,
    ) -> ViStatus,
    pub viWrite: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViConstBuf,
        cnt: ViUInt32,
        retCnt: ViPUInt32,
    ) -> ViStatus,
    pub viWriteAsync: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViConstBuf,
        cnt: ViUInt32,
        jobId: ViPJobId,
    ) -> ViStatus,
    pub viWriteFromFile: unsafe extern "C" fn(
        vi: ViSession,
        filename: ViConstString,
        cnt: ViUInt32,
        retCnt: ViPUInt32,
    ) -> ViStatus,
    pub viAssertTrigger: unsafe extern "C" fn(vi: ViSession, protocol: ViUInt16) -> ViStatus,
    pub viReadSTB: unsafe extern "C" fn(vi: ViSession, status: ViPUInt16) -> ViStatus,
    pub viClear: unsafe extern "C" fn(vi: ViSession) -> ViStatus,
    pub viSetBuf: unsafe extern "C" fn(vi: ViSession, mask: ViUInt16, size: ViUInt32) -> ViStatus,
    pub viFlush: unsafe extern "C" fn(vi: ViSession, mask: ViUInt16) -> ViStatus,
    pub viBufWrite: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViConstBuf,
        cnt: ViUInt32,
        retCnt: ViPUInt32,
    ) -> ViStatus,
    pub viBufRead: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViPBuf,
        cnt: ViUInt32,
        retCnt: ViPUInt32,
    ) -> ViStatus,
    pub viPrintf: unsafe extern "C" fn(vi: ViSession, writeFmt: ViConstString, ...) -> ViStatus,
    pub viVPrintf: unsafe extern "C" fn(
        vi: ViSession,
        writeFmt: ViConstString,
        params: *mut __va_list_tag,
    ) -> ViStatus,
    pub viSPrintf:
        unsafe extern "C" fn(vi: ViSession, buf: ViPBuf, writeFmt: ViConstString, ...) -> ViStatus,
    pub viVSPrintf: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViPBuf,
        writeFmt: ViConstString,
        parms: *mut __va_list_tag,
    ) -> ViStatus,
    pub viScanf: unsafe extern "C" fn(vi: ViSession, readFmt: ViConstString, ...) -> ViStatus,
    pub viVScanf: unsafe extern "C" fn(
        vi: ViSession,
        readFmt: ViConstString,
        params: *mut __va_list_tag,
    ) -> ViStatus,
    pub viSScanf: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViConstBuf,
        readFmt: ViConstString,
        ...
    ) -> ViStatus,
    pub viVSScanf: unsafe extern "C" fn(
        vi: ViSession,
        buf: ViConstBuf,
        readFmt: ViConstString,
        parms: *mut __va_list_tag,
    ) -> ViStatus,
    pub viQueryf: unsafe extern "C" fn(
        vi: ViSession,
        writeFmt: ViConstString,
        readFmt: ViConstString,
        ...
    ) -> ViStatus,
    pub viVQueryf: unsafe extern "C" fn(
        vi: ViSession,
        writeFmt: ViConstString,
        readFmt: ViConstString,
        params: *mut __va_list_tag,
    ) -> ViStatus,
    pub viIn8: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val8: ViPUInt8,
    ) -> ViStatus,
    pub viOut8: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val8: ViUInt8,
    ) -> ViStatus,
    pub viIn16: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val16: ViPUInt16,
    ) -> ViStatus,
    pub viOut16: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val16: ViUInt16,
    ) -> ViStatus,
    pub viIn32: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val32: ViPUInt32,
    ) -> ViStatus,
    pub viOut32: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val32: ViUInt32,
    ) -> ViStatus,
    pub viIn64: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val64: ViPUInt64,
    ) -> ViStatus,
    pub viOut64: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        val64: ViUInt64,
    ) -> ViStatus,
    pub viIn8Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val8: ViPUInt8,
    ) -> ViStatus,
    pub viOut8Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val8: ViUInt8,
    ) -> ViStatus,
    pub viIn16Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val16: ViPUInt16,
    ) -> ViStatus,
    pub viOut16Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val16: ViUInt16,
    ) -> ViStatus,
    pub viIn32Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val32: ViPUInt32,
    ) -> ViStatus,
    pub viOut32Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val32: ViUInt32,
    ) -> ViStatus,
    pub viIn64Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val64: ViPUInt64,
    ) -> ViStatus,
    pub viOut64Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        val64: ViUInt64,
    ) -> ViStatus,
    pub viMoveIn8: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveOut8: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveIn16: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveOut16: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveIn32: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveOut32: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveIn64: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveOut64: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress,
        length: ViBusSize,
    ...
    pub viMoveIn8Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveOut8Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveIn16Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveOut16Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveIn32Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveOut32Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveIn64Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveOut64Ex: unsafe extern "C" fn(
        vi: ViSession,
        space: ViUInt16,
        offset: ViBusAddress64,
        length: ViBusSize,
    ...
    pub viMoveAsync: unsafe extern "C" fn(
        vi: ViSession,
        srcSpace: ViUInt16,
        srcOffset: ViBusAddress,
        srcWidth: ViUInt16,
    ...
    pub viMoveEx: unsafe extern "C" fn(
        vi: ViSession,
        srcSpace: ViUInt16,
    ...
    pub viMoveAsyncEx: unsafe extern "C" fn(
        vi: ViSession,
        srcSpace: ViUInt16,
        srcOffset: ViBusAddress64,
        srcWidth: ViUInt16,
    ...
    pub viMapAddress: unsafe extern "C" fn(
        vi: ViSession,
        mapSpace: ViUInt16,
    ...
    pub viUnmapAddress: unsafe extern "C" fn(vi: ViSession) -> ViStatus,
    pub viMapAddressEx: unsafe extern "C" fn(
        vi: ViSession,
        mapSpace: ViUInt16,
    ...
    pub viPeek8: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val8: ViPUInt8),
    pub viPoke8: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val8: ViUInt8),
    pub viPeek16: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val16: ViPUInt16),
    pub viPoke16: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val16: ViUInt16),
    pub viPeek32: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val32: ViPUInt32),
    pub viPoke32: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val32: ViUInt32),
    pub viPeek64: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val64: ViPUInt64),
    pub viPoke64: unsafe extern "C" fn(vi: ViSession, address: ViAddr, val64: ViUInt64),
    pub viMemAlloc:
        unsafe extern "C" fn(vi: ViSession, size: ViBusSize, offset: ViPBusAddress) -> ViStatus,
    pub viMemFree: unsafe extern "C" fn(vi: ViSession, offset: ViBusAddress) -> ViStatus,
    pub viMemAllocEx:
        unsafe extern "C" fn(vi: ViSession, size: ViBusSize, offset: ViPBusAddress64) -> ViStatus,
    pub viMemFreeEx: unsafe extern "C" fn(vi: ViSession, offset: ViBusAddress64) -> ViStatus,
    pub viGpibControlREN: unsafe extern "C" fn(vi: ViSession, mode: ViUInt16) -> ViStatus,
    pub viGpibControlATN: unsafe extern "C" fn(vi: ViSession, mode: ViUInt16) -> ViStatus,
    pub viGpibSendIFC: unsafe extern "C" fn(vi: ViSession) -> ViStatus,
    pub viGpibCommand: unsafe extern "C" fn(
        vi: ViSession,
        cmd: ViConstBuf,
        cnt: ViUInt32,
        retCnt: ViPUInt32,
    ...
    pub viGpibPassControl:
        unsafe extern "C" fn(vi: ViSession, primAddr: ViUInt16, secAddr: ViUInt16) -> ViStatus,
    pub viVxiCommandQuery: unsafe extern "C" fn(
        vi: ViSession,
        mode: ViUInt16,
        cmd: ViUInt32,
        response: ViPUInt32,
    ) -> ViStatus,
    pub viAssertUtilSignal: unsafe extern "C" fn(vi: ViSession, line: ViUInt16) -> ViStatus,
    pub viAssertIntrSignal:
        unsafe extern "C" fn(vi: ViSession, mode: ViInt16, statusID: ViUInt32) -> ViStatus,
    pub viMapTrigger: unsafe extern "C" fn(
        vi: ViSession,
        trigSrc: ViInt16,
        trigDest: ViInt16,
        mode: ViUInt16,
    ...
    pub viUnmapTrigger:
        unsafe extern "C" fn(vi: ViSession, trigSrc: ViInt16, trigDest: ViInt16) -> ViStatus,
    pub viUsbControlOut: unsafe extern "C" fn(
        vi: ViSession,
    ...
    pub viUsbControlIn: unsafe extern "C" fn(
        vi: ViSession,
        bmRequestType: ViInt16,
        bRequest: ViInt16,
        wValue: ViUInt16,
    ...
    pub viPxiReserveTriggers: unsafe extern "C" fn(
        vi: ViSession,
        cnt: ViInt16,
        trigBuses: ViAInt16,
        trigLines: ViAInt16,
